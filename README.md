...
#####f_project/
    ...
    requirements.txt
    static/
        context.png - picture used for the site design
        image.png - icon
        styles.css
    templates/
        error.html - is displayed in case of inapropriate input
        history.html - list of learnt word and created sentences
        index.html - home page with a form for words
        layout.html
        result.html - shows different content depending on corret and incorrect answers
        sentence.html - displays the created sentence, question for the sentence and a form for user's answer
